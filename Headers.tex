...
%Set up the blocks and the numbering of the sections and parts
\renewcommand{\partname}{Block}
...
% --- Hierarchical Numbering for the Handbook ---
% --- Hierarchical Numbering for the Handbook ---
\mode<article>{
    % 1. Link section numbering to part (Block)
    \numberwithin{section}{part}
    
    % 2. Fix the "0.x" issue for the Intro sections
    \renewcommand{\thesection}{%
        \ifnum\value{part}=0
            I.\arabic{section}% Before Block 1: Just print "1, 2"
        \else
            \thepart.\arabic{section}% Inside a Block: Print "1.1, 1.2"
        \fi
    }
}
...
%Remove the second well items which can look like minuses
\only<article>{\renewcommand{\labelitemii}{$\circ$}}

%Add a solution continued enviroment to stop the renumber problem
\newtheorem*{solutioncont}{\only<presentation>{Solution (Continued)}}
...
% Title Formatting
\title[MATH19622-1E2]{\textbf{MATH19622-1E2: Introduction to Probability and Statistics}\\
