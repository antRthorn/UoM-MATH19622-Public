...
\begin{frame}{Help Improve This Module!}
    \centering
    Since this course was a \alert{completely new development} this year, your brutally honest feedback is crucial for helping us refine and restructure the materials for future cohorts.

    \vspace{0.5cm}
    It only takes \textbf{5 minutes}!

    \vspace{1.0cm}
    \centering
    \qrcode[height=3.5cm]{https://www.menti.com/al22sa8szw8s}

    \vspace{0.5cm}
    Scan the code or go to \href{https://www.menti.com/al22sa8szw8s}{menti.com/al22sa8szw8s}
\end{frame}

\begin{frame}{Thank You and Good Luck!}
    \centering
    \vspace{1cm}
    \Large \textbf{Thank you for your attendance and engagement!}

    \vspace{0.5cm}
    \normalsize
    I hope you enjoyed this newly developed course as much as I enjoyed teaching it.

    \vspace{1cm}
    \Large \alert{Now, it is time for revision.}

    \vspace{0.5cm}
    \normalsize
    Best of luck with your preparation and the final exam!
\end{frame}
}