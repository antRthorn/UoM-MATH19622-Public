...
\begin{frame}[allowframebreaks,label=History]{History of the course}
...
\begin{frame}[label=StudentAcknowledgements]
\frametitle{Student Acknowledgements}
 A huge thank you to the sharp-eyed students who have helped improve these materials by pointing out errors! (Spotting a mistake earns you a place on this list and a gift voucher at the end of the year).
    \begin{itemize}
        \item Chandramouli Goswami
        \item Omar Shehadeh
        \item Lequan Zhang
        \item Ziheng Shao*
        \item \emph{forfreedomforrich-eng/}
        \item \emph{hassan-tahirr}
        \item gulebi*
...
\begin{frame}[label=CourseStructure]
...
\begin{frame}[label=CourseOverview]
...
\begin{frame}[fragile,label=CloneTheCourse]{Accessing the Living Course Materials}
    ...
    \vspace{0.3cm}
    \structure{How to get the code (for the interested):}
    \begin{enumerate}
...
\only<presentation>{
\begin{frame}[label=Prize]{The QA Bounty Program}
      \begin{itemize}
