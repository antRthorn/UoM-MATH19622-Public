...
\begin{frame}<presentation>{Recap: Descriptive Statistics}
    Last week, we learned how to summarise historical data by separating the \textbf{Signal} from the \textbf{Noise}.
    ...
    Descriptive statistics let us understand the \textbf{past}. Today, we begin using Probability to predict the \textbf{future}.
\end{frame}
